...
class Main extends CI_Controller {
		...
		public function index()
		{
			...
			$data['berita_terbaru'] = $this->db->query("select *, a.id_users as users from berita a join users b on a.id_users = b.id_users join kategori c on a.id_kategori = c.id_kategori where a.status = 'Y' and pilihan = 'N' and headline = 'N' and indepth = 'N' and wawancara = 'N' and NOT a. id_kategori = '20' and NOT a.id_kategori = '23' and NOT a.id_kategori = '26' and NOT a.id_kategori = '27' ORDER BY  id_berita desc limit 3
			")->result();
			$data['berita_terbaru2'] = $this->db->query("select *, a.id_users as users from berita a join users b on a.id_users = b.id_users join kategori c on a.id_kategori = c.id_kategori where a.status = 'Y' and pilihan = 'N' and headline = 'N' and indepth = 'N' and wawancara = 'N' and NOT a. id_kategori = '20' and NOT a.id_kategori = '23' and NOT a.id_kategori = '26' and NOT a.id_kategori = '27' ORDER BY  id_berita desc limit 3 offset 3
			")->result();
			$data['berita_terbaru3'] = $this->db->query("select *, a.id_users as users from berita a join users b on a.id_users = b.id_users join kategori c on a.id_kategori = c.id_kategori where a.status = 'Y' and pilihan = 'N' and headline = 'N' and indepth = 'N' and wawancara = 'N' and NOT a. id_kategori = '20' and NOT a.id_kategori = '23' and NOT a.id_kategori = '26' and NOT a.id_kategori = '27' ORDER BY  id_berita desc limit 3 offset 6
			")->result();
